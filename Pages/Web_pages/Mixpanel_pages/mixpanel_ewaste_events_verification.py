...
def test_ewaste_events_verification():
    compare_csv_by_column(predefine_ewaste_events, mixpanel_events, column_1, column_2, mixpanel_ewaste_events_results)
    post_results_to_zephyr(mixpanel_ewaste_events_results)

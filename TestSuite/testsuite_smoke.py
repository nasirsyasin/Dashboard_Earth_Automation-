...
class MobileTestSuite:
    ...
    def execute_tests(self):
        self.run_tests()
        log_test_result("Verify that Execute_login_with_email successfully", self.execute_login_with_email_status)
        log_test_result("Verify tht Execute_track_action successfully", self.execute_track_action_status)
        log_test_result("Verify that Execute_compost successfully", self.execute_compost_status)
        log_test_result("Verify that Execute_ewaste successfully", self.execute_ewaste_status)
